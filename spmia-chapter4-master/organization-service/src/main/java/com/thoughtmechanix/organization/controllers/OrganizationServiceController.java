...
public class OrganizationServiceController {
    ...
    @RequestMapping(value="/{organizationId}",method = RequestMethod.POST,produces="application/x-www-form-urlencoded;charset=UTF-8")
    public void saveOrganization(@RequestBody Organization org) {
        System.err.println("run....post");
